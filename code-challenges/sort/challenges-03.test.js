...
const sortSchedule = (arr) => {
  const firstSort = sortMeetingsByDay(meetings);
  firstSort.sort((a, b) => {
    if (a.dayOfWeek === b.dayOfWeek && a.start !== b.start) { return a.start - b.start }
    else if (a.dayOfWeek === b.dayOfWeek && a.start === b.start && a.end !== b.end) {
      return a.end - b.end
    }
  })
  return arr;
